...
const faqData: FAQItem[] = [
  {
    question: "What is Summit and who is it for?",
    answer:
      "Summit is a comprehensive billing automation platform designed for businesses that need custom contract management. It's perfect for SaaS companies, service providers, and enterprises looking to streamline their billing processes.",
  },
  {
  ...
  {
    question: "Can I integrate Summit with my existing tools?",
    answer:
      "Yes! Summit integrates seamlessly with popular CRM systems, accounting software, and payment processors. We support APIs and webhooks for custom integrations with your existing workflow.",
  },
  {
  ...
  {
    question: "Is my data secure with Summit?",
    answer:
  ...
  {
    question: "How do I get started with Summit?",
    answer:
